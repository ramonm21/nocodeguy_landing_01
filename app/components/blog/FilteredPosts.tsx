...
export default function FilteredPosts({ posts, tags }: FilteredPostsProps) {
      ...
      <div className="space-y-8">
        {filteredPosts.map((post) => (
          <Link 
            ...
            key={post.slug}
          >
            <article className="group relative rounded-2xl overflow-hidden bg-white hover:shadow-xl transition-all duration-300 border border-gray-100">
